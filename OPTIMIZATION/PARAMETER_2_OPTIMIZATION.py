...
def backtest_and_analyze(data, entry_signals_func, exit_signals_func, parameter_1, parameter_2,name_param_1,name_param_2, freq='15min', fees=0.001):
...
if __name__ == "__main__":
    ...
    # PUT THE PARAMETER 
    fast_window = np.arange(10, 90, 10)
    slow_window = np.arange(100, 200, 10)
    ...
    results = backtest_and_analyze(
        ...
        parameter_2=slow_window,
        name_param_1='fastsema',
        name_param_2='slowsema'
    )
