...
def backtest_and_analyze(data, entry_signals_func, exit_signals_func, parameter_1, parameter_2,parameter_3,name_param_1,name_param_2,name_param_3, freq='15min', fees=0.001):
